...
/// Best Selling / horizontal product row card - same design as reference:
...
class BestSellingProductCard extends StatelessWidget {
  ...
  const BestSellingProductCard({super.key, required this.product, this.onTap});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Content - name and price (constrained to avoid overflow in narrow cards)
          Padding(
